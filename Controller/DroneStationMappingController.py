...
class DroneStationMappingController():
    ...
    def update_drone_station_mapping(data):
        try:
            ...
            if station is None:
                return {}
            drone_station_mapping = DroneStationMapping.query.filter_by(drone_id=data['id'],validity=1).first()
    ...
    def delete_drone_station_mapping_by_id(id):
        try:
            drone_station_mapping = DroneStationMapping.query.filter_by(drone_id=id,validity=1).first()
