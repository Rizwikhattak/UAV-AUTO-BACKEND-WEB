...
class DroneController():
    ...
    def insert_drone(data,drone_img):
        try:
            ...
            if station:
                drone = Drone(station_id=data['station_id'],name=data['name'],speed=data['speed'],flight_duration=data['flight_duration'],ceiling=data['ceiling'],fps=data['fps'])
    ...
    def update_drone_by_id(data, drone_img):
        try:
            ...
            drone_station_mapping = DroneStationMappingController.get_drone_station_mapping_by_drone_id(data.get('id'))
            ...
            if drone:
                ...
                if new_station_id is not None and new_station_id != "":
                    ...
                    newDrone = {'id':drone.id,'station_id':new_station_id,
                                'name':drone.name,'speed':drone.speed,
                                'ceiling':drone.ceiling,'flight_duration':drone.flight_duration,
                                'fps':drone.fps,'image_path':drone.image_path}
                    DroneStationMappingController.update_drone_station_mapping(newDrone)
