...
class MissionPlanner(db.Model):
    ...
    missionPanelMap = db.relationship('MissionPanelMap', back_populates='missionPlanner')
    efficiencyReport = db.relationship('EfficiencyReport', back_populates='missionPlanner')
    maintenanceSchedules = db.relationship(
        'MaintenanceSchedule',
        back_populates='missionPlanner'
    )
